...
class Tabs {
	...
	Tabs(String title, String checksum, RSyntaxTextArea textarea, File file) {
		this.title = title;
	...
	public void setTextarea() {
		...
		// Set codeLang for textarea syntax
		this.setCodeLang();
	...
	public void setCodeLang() {
		if (this.file != null) {
			try {
				...
				this.codeLang = tika.detect(this.file);
